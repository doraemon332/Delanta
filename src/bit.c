...
const struct flag_type act_flags[] =
{
    ...
    {	"join_mag",		ACT_JOIN_MAG,		TRUE	},
    {	"join_war",		ACT_JOIN_WAR,		TRUE	},
    {	"join_thi",		ACT_JOIN_THI,		TRUE	},
    {	"join_phy",		ACT_JOIN_PHY,		TRUE	},
    {	"join_che",		ACT_JOIN_CHE,		TRUE	},
    {	"join_bio",		ACT_JOIN_BIO,		TRUE 	},
    {	"join_her",		ACT_JOIN_HER,		TRUE	},
    {	"",			0,			0	}
};
