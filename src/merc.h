...
typedef struct	new_skill_type		SKILL_TYPE;
typedef struct	skill_type		OLD_SKILL_TYPE;
...
#define MAX_CLASS		   10
#define MAX_RACE                   42
#define MAX_LEVEL		   306
#define MAX_SOCIALS		   256
#define MAX_SKILL_EXP	         99000
...
#define CLASS_NONE	 	5
#define CLASS_PHYSICALIST   	6
#define CLASS_CHEMICALIST   	7
#define CLASS_BIOLOGIST		8
#define CLASS_HERCULES		9
...
struct  key_data
{
    ...
    void *      ptrs[8];	/* Increase if you have > 6 parms/line   */
};
...
struct	class_type
{
    ...
    int		fAngry_point;		/* Angry point gains on level	*/
...
#define ACT_JOIN_WAR		   4096
#define ACT_JOIN_MAG		   8192
#define ACT_JOIN_THI		  16384
#define ACT_JOIN_PHY              32768
#define ACT_JOIN_CHE              65536
#define ACT_JOIN_BIO             262144
#define ACT_JOIN_HER             524288
...
/*
 * For skills that can use by players who has different classes.
 */
#define SKILL_ACT_NONE		0
#define SKILL_ACT_MAG		1
#define SKILL_ACT_WAR		2
#define SKILL_ACT_THI		4
#define SKILL_ACT_CLE		8
#define SKILL_ACT_PSI		16
#define SKILL_ACT_PHY		32
#define SKILL_ACT_CHE		64
#define SKILL_ACT_AST		128
#define SKILL_ACT_NUC		256
#define SKILL_ACT_BIO		512
...
#define OBJ_VNUM_SCHOOL_MACE	   1004
#define OBJ_VNUM_SCHOOL_DAGGER	   1001
#define OBJ_VNUM_SCHOOL_SWORD	   1002
#define OBJ_VNUM_SCHOOL_VEST	   1003
#define OBJ_VNUM_SCHOOL_SHIELD	   1005
#define OBJ_VNUM_SCHOOL_BANNER     1006
#define OBJ_VNUM_SCHOOL_CLUB       1007
#define OBJ_VNUM_SCHOOL_REFERENCE_BOOK		1002
...
#define ROOM_VNUM_CHAT		   4001
#define ROOM_VNUM_DEADRIVER	   2001
#define ROOM_VNUM_TEMPLE	   1001
#define ROOM_VNUM_SCHOOL	   1001
#define ROOM_VNUM_GRAVEYARD_A	   1001
...
#define PLR_AUTOTIME	       67108864
#define PLR_LOOKSKY	      134217728
...
#define IS_DIRECT( ch )         ( get_trust( ch ) >= L_JUN )
...
#define IS_LEARNED( ch, sn )	( ( ch->pcdata->learned[sn] > 0 ) && ( skill_table[sn].name ) )
...
#define PERS( ch, looker )	( can_see( looker, ( ch ) ) ?		     \
				( IS_NPC( ch ) ? ( ch )->short_descr	     \
				               : ( ch )->name ) : "不明人物" )
#define CPERS( ch, looker )	( can_see( looker, ( ch ) ) ?		     \
			        ( ch->cname ) : "不明人物" )
...
extern  struct	new_skill_type * skill_table;
...
DECLARE_DO_FUN( do_cname	);		/* by Doraemon */
...
#define SOCIAL_FILE	"SOCIALS.TXT"   /* For social commands		*/
#define SKILL_FILE	"SKILLS.TXT"	/* For skills			*/
#define OS_VERSION	"OSVERSION"	/* For Login's os versions	*/
#define SYS_ANN		"SYS_ANN.TXT"	/* For the system's announce	*/
...
void	remove_all_obj	args( ( CHAR_DATA *ch ) );
void	unequip_all_obj	args( ( CHAR_DATA *ch ) );
...
int	_sort_descriptor_by_level	args( ( DESCRIPTOR_DATA **d1, DESCRIPTOR_DATA **d2 ) );
int	_sort_descriptor_by_name	args( ( DESCRIPTOR_DATA **d1, DESCRIPTOR_DATA **d2 ) );
void	sort_descriptor	args( ( int sorting ) );
...
int	ansi_strlen	args( ( const char * argument ) );
...
bool	load_char_obj_backup	args( ( DESCRIPTOR_DATA *d, char *name ) );
...
bool	is_inv_obj		args ( (CHAR_DATA* ch, char* opr, char* val) );
bool	is_equ_obj 		args ( (CHAR_DATA* ch, char* opr, char* val) );
...
/* skills.c */
void	fwrite_skill	args( ( OLD_SKILL_TYPE skills, FILE *fp ) );
int	can_learn	args( ( CHAR_DATA *ch, int sn ) );
